          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Text('Tap map to select location', style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.8),
                ),),
                SizedBox(height: 5),
                _buildLocationPicker(context),
                SizedBox(height: 20),
                DefaultButton(text: 'Create', onPressed: () {
    ...
    return Container(
      ...
      child: GoogleMap(
        ...
        markers: myLocation != null ? {
          Marker(markerId: MarkerId('selectedLocation'), position: myLocation!)
        } :{},
